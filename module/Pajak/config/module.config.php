...
return array(
    'controllers' => array(
        'invokables' => array(
            ...
            'CekSppt' => 'Pajak\Controller\Perizinan\CekSppt',
            'CekTunggakan' => 'Pajak\Controller\Perizinan\CekTunggakan',
            ...
            'Userman' => 'Pajak\Controller\Userman\Userman',
    ...
    'router' => array(
        'routes' => array(
            ...
            'ceksppt' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/ceksppt[/:action][/:page][/:rows][/:direction][/:combocari][/:kolomcari][/:combosorting][/:sortasc][/:sortdesc][/:combooperator]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ),
            ...
            'cektunggakan' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/cektunggakan[/:action][/:page][/:rows][/:direction][/:combocari][/:kolomcari][/:combosorting][/:sortasc][/:sortdesc][/:combooperator]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ),
            ...
            'setting_targetopd' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/setting_targetopd[/:action][/:page][/:rows][/:direction][/:combocari][/:kolomcari][/:combosorting][/:sortasc][/:sortdesc][/:combooperator]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ),
            ...
            'userman' => array(
                'type' => 'segment',
                'options' => array(
                    'route' => '/userman[/:action][/:page][/:rows][/:direction][/:combocari][/:kolomcari][/:combosorting][/:sortasc][/:sortdesc][/:combooperator]',
                    'constraints' => array(
                        'action' => '[a-zA-Z][a-zA-Z0-9_-]*',
                        'id' => '[0-9]+',
                    ),
