...
class Pendataan extends AbstractActionController
{
    ...
    public function hitungpajakreklameAction()
    {
        ...
        } else if ($postedData['t_jenisreklame'] == 10) {
    ...
    public function pilihRekeningAction()
    {
        ...
        //     $t_klasifikasi .= "<option value=''>Silahkan Pilih</option>";
        //     $t_klasifikasi .= "<option value='" . 1 . "'>Berasal Dari PLN untuk kebutuhan rumah tangga</option>";
        //     $t_klasifikasi .= "<option value='" . 2 . "'>Berasal Dari PLN khusus untuk kegiatan industri, pertambangan migas</option>";
        // } else {
        //     $t_klasifikasi .= "<option value=''>Silahkan Pilih</option>";
        //     $t_klasifikasi .= "<option value='" . 3 . "'>Dihasilkan sendiri dengan memasang alat ukur</option>";
        //     $t_klasifikasi .= "<option value='" . 4 . "'>Dihasilkan sendiri dengan tidak memasang alat ukur</option>";
        // }
    ...
    public function caritarifminerbaAction()
    {
        ...
        foreach ($dataRekening as $v) {
            ...
            $s_besarpungutan = $v['s_persentarifkorek'] * $v['s_tarifdasarkorek'] / 100;
        }
    ...
    public function carijenisminerbaAction()
    {
        $req = $this->getRequest();
        $data_get = $req->getPost();
        $dataJenisminerba = $this->Tools()->getService('RekeningTable')->getDataJenisMinerba();
        $opsi = "";
        $opsi .= "
            <option value=''>Silahkan Pilih</option>";
