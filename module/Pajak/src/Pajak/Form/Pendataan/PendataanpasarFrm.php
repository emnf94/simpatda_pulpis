...
class PendataanpasarFrm extends Form {
   ...
   $this->add(array(
            ...
            'attributes' => array(
                ...
                'onchange' => 'hitungjangkawaktu();hitungretribusipasar();',
            )
        ));
     ...
     $this->add(array(
        ...
        $this->add(array(
            ...
            'attributes' => array(
                'id' => 't_klasifikasi',
                'class' => 'form-control',
                'onchange' => 'cariKlasifikasiTarifPasar()',
           ),
            'options' => array(
                'empty_option' => 'Silahkan Pilih',
                'value_options' => [
                    1 => '01 || Ibukota Kabupaten',
                    2 => '02 || Ibukota Kecamatan',
                    3 => '03 || Didesa'
                ],
        ...
        $this->add(array(
            'name' => 't_keteranganpasar',
            'type' => 'text',
            'attributes' => array(
                'id' => 't_keteranganpasar',
                'class' => 'form-control'
            )
        ));
        ...
        $this->add(array(
            ...
            'attributes' => array(
                ...
                // 'required' => true,
                'style' => 'text-align:right',
                'onchange' => 'hitungretribusipasar()',
                'onblur' => 'hitungretribusipasar()'
            )
        ));
