...
class PendataantanahlainFrm extends Form {
    ...
    public function __construct() {
        ...
        $this->add(array(
            ...
            'attributes' => array(
                ...
                'required' => true,
                'style' => 'text-align:right',
                'onchange' => 'hitungrettanahlain()',
                'onblur' => 'hitungrettanahlain()'
            )
        ));
        ...
        $this->add(array(
            ...
            'attributes' => array(
                ...
                'required' => true,
                'style' => 'text-align:right',
                'onchange' => 'hitungrettanahlain();this.value = formatCurrency(this.value);',
                'onblur' => 'hitungrettanahlain();this.value = formatCurrency(this.value);',
                'onkeyup' => 'hitungrettanahlain();this.value = formatCurrency(this.value);',
