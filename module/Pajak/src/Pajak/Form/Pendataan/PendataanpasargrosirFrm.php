...
class PendataanpasargrosirFrm extends Form {
    ...
    public function __construct($comboIdKlasifikasi = null) {
        ...
        $this->add(array(
            ...
            'attributes' => array(
                'id' => 't_klasifikasi',
                'class' => 'form-control',
                'onchange' => 'cariKlasifikasiTarifPasargrosir()',
            ),
            'options' => array(
                'empty_option' => 'Silahkan Pilih',
                 'value_options' => [
                    1 => '01 || Non Pasar Inpres Dalam Ibukota Kabupaten',
                    2 => '02 || Non Pasar Inpres Semi Permane Dalam Ibukota Kabupaten',
                    3 => '03 || Pasar Inpres'
                ],
        ...
        $this->add(array(
            'name' => 't_jenisbangunan',
            'type' => Select::class,
            'attributes' => array(
                'id' => 't_jenisbangunan',
                'class' => 'form-control',
                'onchange' => 'hitungretribusipasargrosir()',
            ),
            'options' => array(
                'empty_option' => 'Silahkan Pilih',
                // 'value_options' => $comboIdKlasifikasi,
                'disable_inarray_validator' => true, // <-- disable
            )
        ));
        ...
        $this->add(array(
            ...
            'attributes' => array(
                ...
                'style' => 'text-align:right',
                'onchange' => 'hitungretribusipasargrosir()',
                'onblur' => 'hitungretribusipasargrosir()'
            )
        ));
