...
class PendaftaranFrm extends Form
{
    ...
    public function __construct($comboid_kecamatan = null, $comboid_kelurahan = null, $nopendaftaran = null, $comboid_kelurahan_badan = null)
    {
        parent::__construct();
        ...
        $this->add(array(
            ...
            'type' => 'Zend\Form\Element\Select',
            'attributes' => array(
                'id' => 't_kecamatan_badan',
                'class' => 'form-control',
                'required' => true,
                'onchange' => 'comboKelurahanCamat_badan();'
            ),
            'options' => array(
                'empty_option' => 'Silahkan Pilih',
                'value_options' => $comboid_kecamatan,
        ...
        $this->add(array(
            ...
            'type' => 'Zend\Form\Element\Select',
            'attributes' => array(
                'id' => 't_kelurahan_badan',
                'class' => 'form-control',
                'required' => true
            ),
            'options' => array(
                'empty_option' => 'Silahkan Pilih',
                'value_options' => $comboid_kelurahan_badan,
                'disable_inarray_validator' => true, // <-- disable
            )
        ));
