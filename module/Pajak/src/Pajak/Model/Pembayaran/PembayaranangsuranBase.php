...
class PembayaranangsuranBase implements InputFilterAwareInterface {

    public $t_idangsuran, $t_idketetapan, $t_jenisketetapan, $t_tglketetapanangsuran, $t_jumlahkaliangsuran, $t_jenispajak;
    ...
    public function exchangeArray($data) {
        $this->t_idangsuran = (isset($data['t_idangsuran'])) ? $data['t_idangsuran'] : null;
