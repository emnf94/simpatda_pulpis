...
class SkpdtPembayaranBase implements InputFilterAwareInterface {

    public $t_idskpdt, $t_tglbayarskpdt, $t_viabayarskpdt, $t_jmlhbayarskpdt;
    ...
    public function exchangeArray($data) {
        ...
        $this->t_tglbayarskpdt = (isset($data['t_tglbayarskpdt'])) ? $data['t_tglbayarskpdt'] : null;
        $this->t_viabayarskpdt = (isset($data['t_viabayarskpdt'])) ? $data['t_viabayarskpdt'] : null;
        $this->t_jmlhbayarskpdt = (isset($data['t_jmlhbayarskpdt'])) ? $data['t_jmlhbayarskpdt'] : null;
