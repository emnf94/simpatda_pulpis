...
class PemeriksaanBase implements InputFilterAwareInterface {
    ...
    public $t_jmlhdendapemeriksaan, $t_jmlhpajakseharusnya, $t_jmlhpajakpemeriksaan, $t_totalpemeriksaan;
    public $t_jenispajak, $t_jenispemeriksaan;
    ...
    public function exchangeArray($data) {
        ...
        $this->t_jenispemeriksaan = (isset($data['t_jenispemeriksaan'])) ? $data['t_jenispemeriksaan'] : null;
