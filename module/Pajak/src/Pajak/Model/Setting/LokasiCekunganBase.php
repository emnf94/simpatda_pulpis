...
class LokasiCekunganBase implements InputFilterAwareInterface {

    public $s_idcekungan, $s_kriteria, $s_nilai;
    ...
    public function exchangeArray($data) {
        $this->s_idcekungan = (isset($data['s_idcekungan'])) ? $data['s_idcekungan'] : null;
        $this->s_kriteria = (isset($data['s_kriteria'])) ? $data['s_kriteria'] : null;
