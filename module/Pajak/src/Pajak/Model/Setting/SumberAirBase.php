...
class SumberAirBase implements InputFilterAwareInterface {

    public $s_idsumberair, $s_jenissumber, $s_nilai;
    ...
    public function exchangeArray($data) {
        $this->s_idsumberair = (isset($data['s_idsumberair'])) ? $data['s_idsumberair'] : null;
        $this->s_jenissumber = (isset($data['s_jenissumber'])) ? $data['s_jenissumber'] : null;
