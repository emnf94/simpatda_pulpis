...
class TipeusahaBase implements InputFilterAwareInterface {

    public $s_idusaha, $s_kodeusaha, $s_namausaha;
    ...
    public function exchangeArray($data) {
        $this->s_idusaha = (isset($data['s_idusaha'])) ? $data['s_idusaha'] : null;
        $this->s_kodeusaha = (isset($data['s_kodeusaha'])) ? $data['s_kodeusaha'] : null;
        $this->s_namausaha = (isset($data['s_namausaha'])) ? $data['s_namausaha'] : null;
