...
class KualitasAirBase implements InputFilterAwareInterface {

    public $s_idfaktorkualitas, $s_namafaktorkualitas, $s_nilai;
    ...
    public function exchangeArray($data) {
        $this->s_idfaktorkualitas = (isset($data['s_idfaktorkualitas'])) ? $data['s_idfaktorkualitas'] : null;
        $this->s_namafaktorkualitas = (isset($data['s_namafaktorkualitas'])) ? $data['s_namafaktorkualitas'] : null;
