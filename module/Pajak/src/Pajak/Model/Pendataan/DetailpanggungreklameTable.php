...
class DetailpanggungreklameTable extends AbstractTableGateway {

    protected $table = 't_detailpanggungreklame';
    ...
    public function simpandetailpanggungreklame($post, $dataparent) {
        $data = array(
    ...
    public function getPendataanPanggungReklameByIdTransaksi($t_idtransaksi) {
