...
class RekambankBase implements InputFilterAwareInterface {

    public $t_idsbh, $t_tglsbh, $t_nosbh;
    ...
    public function exchangeArray($data) {
        $this->t_idsbh = (isset($data['t_idsbh'])) ? $data['t_idsbh'] : null;
        $this->t_tglsbh = (isset($data['t_tglsbh'])) ? $data['t_tglsbh'] : null;
        $this->t_nosbh = (isset($data['t_nosbh'])) ? $data['t_nosbh'] : null;
